...
<div class="container_fluid" style="margin-top: 100px; margin-left: 700px;margin-right: 700px; width: 500px;">
    <div class="col-lg-12">
        <form id="manage-movie" action="includes/update.inc.php?updateid=<?php echo $_GET['updateid'];?>" method="post" enctype="multipart/form-data">
            ...
            <div>
                <button name="update_movies">hello</button>
